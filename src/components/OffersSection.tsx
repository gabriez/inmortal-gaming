...
const OFFERS = [
  {
    ...
    description: 'Usa el código BIENVENIDO10 al pagar por WhatsApp. Válido para cualquier producto.',
    code: 'BIENVENIDO10',
    color: 'neon-primary',
  },
  {
    title: 'Combo Game Pass + RP',
    description: 'Lleva Xbox Game Pass Ultimate + 6.500 RP con un 15% de descuento.',
    code: 'COMBO15',
    color: 'neon-purple',
  },
  {
    title: 'Envío gratis en Gift Cards',
    description: 'Sin cargos adicionales en todas las Gift Cards de Steam, PlayStation y Xbox.',
    code: null,
    color: 'neon-green',
  },
];
